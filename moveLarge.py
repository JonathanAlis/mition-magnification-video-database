...
dir_name='moveLarge_downsize_'+str(down)
...
freqx_range=[1.0,2.5] #frequence of the movement in the x axis
freqy_range=[1.5, 3.0] #frequence of the movement in the 7 axis
...
for i in range(len(am_files)):
    ...
    v.start_video(num_frames,
                  ...
                  alpha=alpha,fps=fps,pixel_mag=target_mag,downscale=down,addLarge=2,
